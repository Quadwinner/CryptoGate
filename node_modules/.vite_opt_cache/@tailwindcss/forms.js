...
const _default = (0, cloneDeep_1.cloneDeep)(_configfull.default.theme);
});

var defaultTheme_1 = createCommonjsModule(function (module) {
...
const [baseFontSize, { lineHeight: baseLineHeight }] = defaultTheme_1.fontSize.base;
const { spacing, borderWidth, borderRadius } = defaultTheme_1;
    ...
    const rules = [
      {
        ...
        styles: {
          ...
          'border-color': resolveColor(
            theme('colors.gray.500', colors_1.gray[500]),
            '--tw-border-opacity'
          ),
          ...
          '&:focus': {
            ...
            '--tw-ring-color': resolveColor(
              theme('colors.blue.600', colors_1.blue[600]),
              '--tw-ring-opacity'
            ),
      ...
      },
      {
        ...
        styles: {
          color: resolveColor(theme('colors.gray.500', colors_1.gray[500]), '--tw-text-opacity'),
          opacity: '1',
        },
      },
      {
      ...
      },
      {
        ...
        class: ['.form-select'],
        styles: {
          'background-image': `url("${miniSvgDataUri(
      ...
      },
      {
        ...
        styles: {
          ...
          height: spacing[4],
          width: spacing[4],
          color: resolveColor(theme('colors.blue.600', colors_1.blue[600]), '--tw-text-opacity'),
          'background-color': '#fff',
          'border-color': resolveColor(
            theme('colors.gray.500', colors_1.gray[500]),
            '--tw-border-opacity'
